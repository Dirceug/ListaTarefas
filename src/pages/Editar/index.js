...
const getSelecionadosFromUserDevice = async () => {
    try {
    const selecionados = await AsyncStorage.getItem('selecionada');
    if(selecionados != null) {
        setSelecionados(JSON.parse(selecionados));
        setTextInput(selecionados.task)
        setDescriptionInput(selecionados.description)
    }
    } catch (error) {
    console.log(error)
    }
            ...
            {/* <View style={[styles.profile,{backgroundColor: colors[value]}]}> */}
                ...
                <View style={styles.inputContainer}>
                    ...
                    <Text style={styles.text} >
                        Título da tarefa:{selecionados.task}
                    </Text>
                    <TextInput
                    placeholder="Título" 
                    value={textInput}
